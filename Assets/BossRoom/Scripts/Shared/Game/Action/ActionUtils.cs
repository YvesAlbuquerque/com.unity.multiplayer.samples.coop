...
namespace Unity.Multiplayer.Samples.BossRoom
{
    public static class ActionUtils
    {
        ...
        public static int DetectMeleeFoe(Collider attacker, float range, out RaycastHit[] results)
        {
            return DetectNearbyEntities(attacker, range, out results);
        }
        ...
        /// <param name="results">Place an uninitialized RayCastHit[] ref in here. It will be set to the results array. </param>
        /// <returns></returns>
        public static int DetectNearbyEntities( Collider attacker, float range, out RaycastHit[] results)
        {
            ...
            int mask =0;
            mask |= (1<< LayerMask.NameToLayer("PCs"));
            // if (wantPcs)
            //     mask |= (1 << s_layer_PCs);
            // if (wantNpcs)
            //     mask |= (1 << s_layer_NPCs);
